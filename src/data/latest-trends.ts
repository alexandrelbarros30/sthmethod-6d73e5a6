...
export const LATEST_TRENDS: TrendArticle[] = [
  { id: "tirzepatida-vs-retatrutida", path: "/tendencias/tirzepatida-vs-retatrutida", kicker: "Tirzepatida × Retatrutida", title: "Tirzepatida ou retatrutida? Não são a mesma coisa", desc: "Uma controla a fome e ensina novos hábitos. A outra refina a composição corporal de quem já domina o comportamento.", img: tirzeRetaImg, publishedAt: "2026-07-30" },
