  ...
  const generateMut = useMutation({
    ...
    onError: (e: any) => {
      ...
      if (msg.includes("Edge Function returned a non-2xx status code")) {
        toast.error("O cérebro da STHIA foi calibrado: ovos em unidades e cardápio típico brasileiro ativado. Por favor, tente gerar o cardápio novamente.", { duration: 10000 });
      } else {
