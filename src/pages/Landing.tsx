...
const coreFeatures = [
  {
    ...
    title: "Área do Aluno",
    description: "Dieta, treino, protocolos e materiais educativos organizados de forma dinâmica e acessível.",
  },
  {
    icon: <FileBarChart className="w-6 h-6" />,
    title: "Perfil Clínico",
    description: "Dados clínicos, objetivos, histórico de evolução e status da assinatura em um só lugar.",
  },
  {
    icon: <Camera className="w-6 h-6" />,
    title: "Check-ins",
    description: "Upload de fotos, medidas corporais, sintomas e feedback subjetivo em períodos configuráveis.",
  },
  {
    icon: <MessageCircle className="w-6 h-6" />,
    title: "Comunicação Direta",
    description: "Chat integrado entre aluno e consultor com notificações e histórico completo.",
  },
  {
    icon: <CreditCard className="w-6 h-6" />,
    title: "Pagamentos",
    description: "Planos recorrentes e avulsos com controle de vencimentos, inadimplência e renovação automática.",
  },
  {
    icon: <LayoutDashboard className="w-6 h-6" />,
    title: "Painel Admin",
    description: "Gestão de alunos, engajamento, retenção e métricas financeiras em tempo real.",
  },
];
...
const extraModules = [
  {
    ...
    badge: "Inovação",
    items: [
      "Alertas inteligentes de risco de churn",
      "Sugestão automática de ajustes de dieta",
  ...
  },
  {
    ...
    items: [
      "Pontos por consistência e check-ins",
      "Rankings e desafios mensais",
      "Recompensas e badges de evolução",
      "Indicação premiada de novos alunos",
    ],
  },
  {
    ...
    badge: "Retenção",
    items: [
      "Streaks de adesão ao plano",
      "Milestones de transformação",
  ...
  },
  {
    ...
    title: "Farmácia & Suplementos",
    items: [
      "Marketplace integrado de suplementos",
      "Prescrições com links diretos de compra",
      "Parcerias com farmácias e labs",
      "Comissão recorrente por indicação",
    ],
  },
  {
    ...
    items: [
      ...
      "Lives e webinars exclusivos",
      "Fórum de alunos por objetivo",
      "Stories de transformação",
    ],
  },
  {
    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-20">
        ...
        >
          ...
          >
            ...
            Plataforma de Consultoria em Saúde & Performance
          </motion.div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Ecossistema completo para consultores de saúde: dieta, treino, protocolos,
            check-ins, pagamentos e gestão — tudo integrado em uma única plataforma.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Cada módulo foi projetado para maximizar a experiência do aluno e a eficiência operacional da consultoria.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-6 surface">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-4">
              Módulos <span className="gradient-text">Estratégicos</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Diferenciais que aumentam retenção, escalabilidade e receita da sua consultoria.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Stack moderna, escalável e segura — pronta para crescer com o seu negócio.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="flex items-start gap-4 p-4 surface rounded-xl border border-border"
              >
                <div className="w-24 shrink-0">
                  <span className="text-xs font-semibold gradient-text uppercase tracking-wider">{item.layer}</span>
                </div>
                <div>
      ...
      <section className="py-24 px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-4">
            Pronto para <span className="gradient-text">transformar</span> sua consultoria?
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">
            Junte-se a centenas de profissionais que já escalaram seus resultados com a plataforma ST&H.
          </p>
          <Link to="/login">
