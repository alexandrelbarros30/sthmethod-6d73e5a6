...
const ads = [
  {
    id: "performeth",
    title: "Performeth Labs",
    desc: "Fórmulas exclusivas de alta performance",
    image: alphaBurn,
  },
  {
    id: "tirzepatida",
    title: "Tirzepatida TG 60mg",
    desc: "Controle glicêmico e redução de peso",
    image: tirzepatida,
  },
];
      ...
      <div className="space-y-4">
            ...
            <CardContent className="p-0">
              <div className="flex items-center gap-4 p-4">
                ...
                <Button
                  ...
                  onClick={() => {
                    if (ad.id === "performeth") setPerformethOpen(true);
                    else setTirzepatidaOpen(true);
                  }}
                >
                  Ver
                </Button>
        ...
        <div className="pt-2 flex gap-2">
          ...
          <Button
            ...
            onClick={() => window.open("https://performethlabs.com.br", "_blank")}
          >
