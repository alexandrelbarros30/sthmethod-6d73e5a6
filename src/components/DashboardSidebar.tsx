  ...
  admin: [
    ...
    { to: "/admin/telefones-autorizados", icon: Phone, label: "Telefones Autorizados" },
    {
      ...
      children: [
        ...
        { to: "/admin/food-ai/dashboard", icon: Sparkles, label: "Food AI · Dashboard" },
    ...
    },
    {
      ...
      children: [
        ...
        { to: "/admin/analise-historico", icon: History, label: "Histórico de Análises" },
      ],
    },
    {
      group: "Conteúdo",
    ...
    },
    {
      ...
      children: [
        ...
        { to: "/admin/backups", icon: Database, label: "Backups do Banco" },
        { to: "/admin/app-releases", icon: Download, label: "Releases APK" },
        { to: "/admin/coach", icon: Dumbbell, label: "STH COACH (Admin)" },
      ],
    },
