...
const TABLE: Array<[string, Macro]> = [
  ...
  // proteínas animais
  ["peito de frango", { kcal: 163, p: 32.0, c: 0, f: 3.2 }],
  ["frango grelhado", { kcal: 163, p: 32.0, c: 0, f: 3.2 }],
  ["frango desfiado", { kcal: 163, p: 31.0, c: 0, f: 3.5 }],
  ["frango", { kcal: 163, p: 32.0, c: 0, f: 3.2 }],
  ["patinho", { kcal: 219, p: 35.9, c: 0, f: 7.3 }],
  ["coxao mole", { kcal: 219, p: 35.9, c: 0, f: 7.3 }],
  ["alcatra", { kcal: 220, p: 32.0, c: 0, f: 9.0 }],
  ["file mignon", { kcal: 220, p: 32.0, c: 0, f: 9.0 }],
  ["carne moida", { kcal: 212, p: 27.0, c: 0, f: 11.0 }],
  ["lombo suino", { kcal: 210, p: 29.0, c: 0, f: 10.0 }],
  ["tilapia", { kcal: 117, p: 25.5, c: 0, f: 1.7 }],
  ["salmao", { kcal: 211, p: 23.5, c: 0, f: 12.5 }],
  ["merluza", { kcal: 113, p: 24.0, c: 0, f: 1.3 }],
  ["pescada", { kcal: 110, p: 23.0, c: 0, f: 1.5 }],
  ["atum", { kcal: 116, p: 25.5, c: 0, f: 0.8 }],
