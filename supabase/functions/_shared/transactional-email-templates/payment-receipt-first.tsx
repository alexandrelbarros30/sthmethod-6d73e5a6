...
const Email = ({
  ...
  return (
    <Html lang="pt-BR" dir="ltr">
      <Head />
      <Preview>Pagamento confirmado — Bem-vindo à STH METHOD</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={brandRow}>
            <Text style={brand}>STH METHOD</Text>
            <Text style={badge}>RECIBO · 1ª ADESÃO</Text>
          </Section>
          ...
          <Section style={card}>
            ...
            <Row><Column style={lbl}>Acesso válido até</Column><Column style={val}>{endDate}</Column></Row>
...
export const template = {
  component: Email,
  subject: 'Pagamento confirmado — STH METHOD',
  displayName: 'Recibo — 1ª adesão',
  previewData: {
    name: 'João Silva', planName: 'Plano Premium', amount: 'R$ 497,00',
    paymentMethod: 'Cartão de crédito', paymentDate: '14/06/2026',
    paymentId: 'MP-1234567890', endDate: '14/09/2026',
    loginUrl: 'https://sthmethod.com.br/dashboard',
  },
