...
- **Privacidade/Canais**: PROIBIDO ABSOLUTO compartilhar o número do Nutri (21 99898-4153). Alunos ativos já são atendidos lá. Leads/Inativos -> Comercial (21 99849-6289).
- **Nutri Silenciado**: Canal Nutri (21 99898-4153) está **SILENCIADO para interações/conversas da IA**. Só dispara mensagens de sistema (boas vindas, liberação de treino/cardápio). Sem interação IA até nova ordem.
