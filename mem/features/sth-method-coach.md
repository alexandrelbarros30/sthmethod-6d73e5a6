...
- Planos: Start 50 / Pro 150 / Business 300 / Enterprise (custom) — definidos em `src/lib/coach-plans.ts`. Limite aplicado por trigger; cobrança ainda não ativa (só exibição).
